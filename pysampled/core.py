    ...
    Propagation invariants (1.2.0+):
        ...
        The split family is:
            - :py:meth:`split_to_1d`, :py:meth:`split_by_signal_name`,
              :py:meth:`split_by_signal_coord` — a `Data` becomes a list of
              `Data`. Matching merge classmethods are not yet provided; they
              were prototyped for 1.2.0 but pulled before release.
    """
